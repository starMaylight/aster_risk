...
/**
 * 7. 呪詛の反撃 - Cursed Retaliation
 * 被ダメ時、エンチャントレベル%の確率で周囲の敵対mobにランダムなデバフをばらまく
 * 最大レベル: 5
 */
public class CursedRetaliationEnchantment extends Enchantment {
    
    public CursedRetaliationEnchantment() {
