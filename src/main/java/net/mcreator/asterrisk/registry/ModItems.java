...
public class ModItems {
	...
	public static final RegistryObject<Item> MOONSTONE_ORE = block(ModBlocks.MOONSTONE_ORE);
	...
	public static final RegistryObject<Item> METEORITE_ORE = block(ModBlocks.METEORITE_ORE);
	public static final RegistryObject<Item> SILVER_ORE = block(ModBlocks.SILVER_ORE);
	public static final RegistryObject<Item> MOONSTONE_BLOCK = block(ModBlocks.MOONSTONE_BLOCK);
	public static final RegistryObject<Item> SILVER_BLOCK = block(ModBlocks.SILVER_BLOCK);
	public static final RegistryObject<Item> STARDUST_BLOCK = block(ModBlocks.STARDUST_BLOCK);
	public static final RegistryObject<Item> METEORITE_BLOCK = block(ModBlocks.METEORITE_BLOCK);
	public static final RegistryObject<Item> MOONSTONE_BRICKS = block(ModBlocks.MOONSTONE_BRICKS);
	public static final RegistryObject<Item> POLISHED_MOONSTONE = block(ModBlocks.POLISHED_MOONSTONE);
	public static final RegistryObject<Item> MOONSTONE_TILES = block(ModBlocks.MOONSTONE_TILES);
	public static final RegistryObject<Item> CRACKED_MOONSTONE_BRICKS = block(ModBlocks.CRACKED_MOONSTONE_BRICKS);
	public static final RegistryObject<Item> MOSSY_MOONSTONE_BRICKS = block(ModBlocks.MOSSY_MOONSTONE_BRICKS);
	public static final RegistryObject<Item> SILVER_BRICKS = block(ModBlocks.SILVER_BRICKS);
	public static final RegistryObject<Item> CHISELED_MOONSTONE = block(ModBlocks.CHISELED_MOONSTONE);
	public static final RegistryObject<Item> STARRY_GLASS = block(ModBlocks.STARRY_GLASS);
	public static final RegistryObject<Item> LUNAR_PILLAR = block(ModBlocks.LUNAR_PILLAR);
	public static final RegistryObject<Item> CELESTIAL_TILE = block(ModBlocks.CELESTIAL_TILE);
	public static final RegistryObject<Item> MOONLIGHT_LANTERN = block(ModBlocks.MOONLIGHT_LANTERN);
	public static final RegistryObject<Item> LUNARGRASS = block(ModBlocks.LUNARGRASS);
	public static final RegistryObject<Item> LUNARDIRT = block(ModBlocks.LUNARDIRT);
	public static final RegistryObject<Item> LUNARSTONE = block(ModBlocks.LUNARSTONE);
	public static final RegistryObject<Item> LUNARLOG = block(ModBlocks.LUNARLOG);
	public static final RegistryObject<Item> LUNARLEAVES = block(ModBlocks.LUNARLEAVES);
	public static final RegistryObject<Item> LUNARPLANKS = block(ModBlocks.LUNARPLANKS);
	public static final RegistryObject<Item> STARFALLSAND = block(ModBlocks.STARFALLSAND);
	public static final RegistryObject<Item> ECLIPSESTONE = block(ModBlocks.ECLIPSESTONE);
	...
	// 機能ブロックアイテム
	public static final RegistryObject<Item> LUNAR_COLLECTOR = block(ModBlocks.LUNAR_COLLECTOR);
	public static final RegistryObject<Item> RESONATOR_TIER1 = block(ModBlocks.RESONATOR_TIER1);
	public static final RegistryObject<Item> RESONATOR_TIER2 = block(ModBlocks.RESONATOR_TIER2);
	public static final RegistryObject<Item> RESONATOR_TIER3 = block(ModBlocks.RESONATOR_TIER3);
	public static final RegistryObject<Item> MANA_BATTERY = block(ModBlocks.MANA_BATTERY);

	// 儀式システム
	public static final RegistryObject<Item> RITUAL_PEDESTAL = block(ModBlocks.RITUAL_PEDESTAL);
	public static final RegistryObject<Item> ALTAR_CORE = block(ModBlocks.ALTAR_CORE);

	// 機能ブロック
	public static final RegistryObject<Item> MOONLIGHT_BEACON = block(ModBlocks.MOONLIGHT_BEACON);
	public static final RegistryObject<Item> LUNAR_INFUSER = block(ModBlocks.LUNAR_INFUSER);
	public static final RegistryObject<Item> STAR_ANVIL = block(ModBlocks.STAR_ANVIL);
	...
	// オベリスク
	public static final RegistryObject<Item> LUNAR_OBELISK = block(ModBlocks.LUNAR_OBELISK);
	public static final RegistryObject<Item> STELLAR_OBELISK = block(ModBlocks.STELLAR_OBELISK);
	public static final RegistryObject<Item> SOLAR_OBELISK = block(ModBlocks.SOLAR_OBELISK);
	public static final RegistryObject<Item> VOID_OBELISK = block(ModBlocks.VOID_OBELISK);

	// 苗木
	public static final RegistryObject<Item> LUNAR_SAPLING = block(ModBlocks.LUNAR_SAPLING);

	// ボス召喚祭壇
	public static final RegistryObject<Item> ECLIPSE_ALTAR = block(ModBlocks.ECLIPSE_ALTAR);
	public static final RegistryObject<Item> STELLAR_SPIRE_CORE = block(ModBlocks.STELLAR_SPIRE_CORE);
	...
	public static final RegistryObject<Item> PHASE_ANVIL = block(ModBlocks.PHASE_ANVIL);
	public static final RegistryObject<Item> METEOR_SUMMONING = block(ModBlocks.METEOR_SUMMONING);

	// 魔法陣クラフトシステムブロックアイテム
	public static final RegistryObject<Item> RITUAL_CIRCLE = block(ModBlocks.RITUAL_CIRCLE);
	public static final RegistryObject<Item> MOONLIGHT_FOCUS = block(ModBlocks.MOONLIGHT_FOCUS);
	public static final RegistryObject<Item> FOCUS_CHAMBER_CORE = block(ModBlocks.FOCUS_CHAMBER_CORE);
	public static final RegistryObject<Item> CELESTIAL_ENCHANTING_TABLE = block(ModBlocks.CELESTIAL_ENCHANTING_TABLE);
